...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 12 Juin 2017 à 10:15
...
CREATE TABLE IF NOT EXISTS `menu` (
  ...
  `menuDestination` tinyint(1) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `utilisateur` (
  ...
  `utilisateurEtat` tinyint(1) NOT NULL DEFAULT '1',
...
(1, '2015-06-13 00:00:00', '2016-09-29 10:14:00', 1, 'Pinelli', 'luc', 0, 'admin@colocarts.com', '1fab942889e352164e44b08114b857111955d31e');
